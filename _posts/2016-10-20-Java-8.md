...
Java 8, Java dili için dev bir ileri adım. Bu kitabı yazmak[1] beni bu konuda daha fazla şey öğrenmeye zorladı. In Project Lambda, Java gets a new closure syntax, method-references, and default methods on interfaces. It manages to add many of the features of functional languages without losing the clarity and simplicity Java developers have come to expect.
